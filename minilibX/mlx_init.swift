...
public class MlxMain {
      ...
      var loopinfo:UnsafeMutableRawPointer
	...
	loopinfo = UnsafeMutableRawPointer(&inLoop)  /// dummy addr init
...
///	if (loopHook != nil)
///	{
	   _ = (unsafeBitCast(loopHook!,to:(@convention(c)(UnsafeRawPointer)->Void).self))(loopinfo)
///	}
    }
