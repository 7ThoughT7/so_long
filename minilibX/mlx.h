...
int	mlx_mouse_hook (void *win_ptr, int (*funct_ptr)(), void *info);
int	mlx_key_hook (void *win_ptr, int (*funct_ptr)(), void *info);
int	mlx_expose_hook (void *win_ptr, int (*funct_ptr)(), void *info);

int	mlx_loop_hook (void *mlx_ptr, int (*funct_ptr)(), void *info);
...
**
**   expose_hook(void *info);
**   key_hook(int keycode, void *info);
**   mouse_hook(int button, int x,int y, void *info);
**   loop_hook(void *info);
**
*/
...
int	mlx_sync(int cmd, void *info);
/*
...
** cmd is one of the define, info will be img_ptr or win_ptr accordingly
*/
